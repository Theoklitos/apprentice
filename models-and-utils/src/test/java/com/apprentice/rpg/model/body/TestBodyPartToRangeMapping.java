...
/**
 * Tests for the {@link BodyPartToRangeMapping}
 * 
 * @author theoklitos
 * 
 */
public final class TestBodyPartToRangeMapping {

	private BodyPartToRangeMapping mapping;
	...
	public void getEquals() {
		final BodyPartToRangeMapping copy = new BodyPartToRangeMapping(mapping);
	...
	public void maxValue() {
		assertEquals(40,mapping.getMaxRangeValue());
		final BodyPart extraPart = new BodyPart("extra part");
		mapping.setPartForRange(45, 91, extraPart);
		assertEquals(91,mapping.getMaxRangeValue());
	}
	...
	public void setup() {
		...
		mapping = new BodyPartToRangeMapping();

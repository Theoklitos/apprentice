 ...
 * 
 */
public class WeaponInstanceSerializer extends ApprenticeParsingComponent implements JsonSerializer<IWeaponInstance> {
	...
	@Override
	public JsonElement serialize(final IWeaponInstance src, final Type typeOfSrc, final JsonSerializationContext context) {		
		final JsonObject result = new JsonObject();
		result.addProperty("prototype", src.getPrototype().getName());
		result.add("hitPoints", context.serialize(src.getDurability()));		
		return result;
	}
